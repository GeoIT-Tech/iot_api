...
#     uuid = Column(UUID(as_uuid=True), primary_key=True, unique=True, default=uuid.uuid4)
#     user_uuid = Column(UUID(as_uuid=True), ForeignKey('users.uuid')) #user uuid
#     reported_uuid = Column(UUID(as_uuid=True), ForeignKey('users.uuid')) #reported uuid
...
#     profile_uuid = Column(UUID(as_uuid=True), ForeignKey('users.uuid'))
#     comment_uuid = Column(UUID(as_uuid=True), ForeignKey('comments.uuid'))
#     reviews_uuid = Column(UUID(as_uuid=True), ForeignKey('reviews.uuid'))
...
#     uuid = Column(UUID(as_uuid=True), primary_key=True, unique=True, default=uuid.uuid4)
#     user_uuid = Column(UUID(as_uuid=True), ForeignKey('users.uuid'))
#     protect_account = Column(Boolean, default=False)
